 ...
 * Version: 2.0.0 — dynamic main.inc.php resolver (no closure), safe includes
 */
...
print '<tr><td class="titlefield"><i class="fas fa-tag"></i> Module Version</td><td><strong>2.0.0</strong></td></tr>';
